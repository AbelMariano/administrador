        ...
        'Pace' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/adminlte/dist/js/JsBarcode.all.min.js',
                ],
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/adminlte/dist/js/validarCampos.js',
                ],
        ...
        'Riot' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/bower_components/riot/riot.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/bower_components/riot/riot+compiler.min.js',
                ],
